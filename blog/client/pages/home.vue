<template>
  <div class="container">
    <div class="row">
      <div class="col-md-4 mt-5">
        <div class="card mb-4 shadow-sm">
          ...
          <div class="card-body">
            <h6 class="card-text ">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
            ...
            <div class="d-flex justify-content-between align-items-center">
              <div class="btn-group">
                <button type="button" class="btn btn-sm btn-primary">
                  <nuxt-link :to="`./post`" class="text-white">
                    Read More
                  </nuxt-link>
                </button>
              </div>
    ...
    <div class="row">
      <div class="col-md-4">
        <div class="card mb-4 shadow-sm">
          ...
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-md-6">
                <p class="ml-2 text-secondary"><font-awesome-icon :icon="['fas', 'folder']" />Technology</p>
              </div>
            </div>
            <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
              incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco
      ...
      <div class="col-md-4">
        ...
        <div class="row border-bottom">
          <div class="col-md-6">
            <a href="./category/_id" class="ml-2 text-secondary">
              Technology</a>
          </div>
    ...
    <!-- Footer -->
    <footer class="container-fluid bg-4 text-center bg-dark">
      <p class="text-white">Copyright 2022 <a href="https://www.w3schools.com"></a></p>
    </footer>
  </div>
