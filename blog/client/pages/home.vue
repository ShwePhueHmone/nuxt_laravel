<template>
  <div class="container">
      ...
      <div class="col-md-4 mt-5 mb-3">
        <div class="card mb-4 shadow-sm">
          <img
            ...
            class="card-img-top" alt="post image" height="50%" />
          <div class="card-body">
            <h5 class="card-title">
            ...
            <div class="d-flex justify-content-between align-items-center">
              <div class="btn-group">
                <button type="button" class="btn btn-sm btn-primary">
                  <nuxt-link :to="`./post/_id`" class="text-white">
                    Read More
                  </nuxt-link>
                </button>
              </div>
        ...
        <div class="card mb-4 shadow-sm">
          ...
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-md-6">
                <p class="ml-2 text-secondary">
                  <font-awesome-icon :icon="['fas', 'folder']" />Technology
                </p>
              </div>
            </div>
            <p class="card-text">
    ...
    <footer class="container-fluid bg-4 text-center bg-dark">
      <p class="text-white">
        Copyright 2022 <a href="https://www.w3schools.com"></a>
      </p>
    </footer>
  </div>
</template>
